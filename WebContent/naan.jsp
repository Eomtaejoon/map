...
removeMarker();
	...
	var latlng = [
		                 ...
		                 {
		                     title: '서울 특별시', 
		                     latlng: new daum.maps.LatLng(37.566535,126.97796919999996)
		                 },
		                 {
		                     title: '인천 광역시', 
		                     latlng: new daum.maps.LatLng(37.4562557,126.70520620000002)
		                 },
		                 {
		                     title: '대전 광역시', 
		                     latlng: new daum.maps.LatLng(36.3504119,127.38454750000005)
		                 },
		                 {
		                     title: '충남 천안시',
		                     latlng: new daum.maps.LatLng(36.815129,127.1138939)
		                 }
		             ];
	// 마커 하나를 지도위에 표시합니다 
	  for(var i=0; i<10; i++){
